...
test("ships the Routine EASY product instead of starter content", async () => {
  ...
  assert.match(routinesRoute, /fontSize = \[11, 14, 18, 22\]/);
  ...
  assert.match(fullPageBuilderCss, /\.routine-instruction ul \{[^}]*list-style: disc outside/);
  assert.match(page, /aria-label="Font size"/);
  assert.match(page, /function instructionFontSize/);
  assert.match(page, /const applyFontSize/);
